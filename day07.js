...
dotted turquoise bags contain 3 vibrant salmon bags, 2 dotted maroon bags, 1 bright beige bags, 1 drab white bags.
...
dim yellow bags contain 1 clear tan bags, 3 dim red bags.
...
muted indigo bags contain 4 vibrant silver bags, 1 wavy tomato bags.
pale olive bags contain 1 clear bronze bags, 3 posh black bags, 2 dim blue bags.
...
light turquoise bags contain 5 striped beige bags, 5 muted black bags, 1 striped maroon bags.
...
shiny maroon bags contain 3 plaid aqua bags, 1 pale plum bags, 5 plaid salmon bags.
wavy gray bags contain 5 pale cyan bags, 1 pale gold bags, 2 pale salmon bags.
dark gray bags contain 2 pale gold bags, 3 muted orange bags, 1 dim maroon bags.
dim beige bags contain 1 dark yellow bags.
dull yellow bags contain 4 pale chartreuse bags.
light aqua bags contain 3 plaid indigo bags, 5 dull black bags.
vibrant silver bags contain 1 posh beige bags, 2 dim cyan bags, 4 light violet bags, 2 dark tan bags.
striped aqua bags contain 4 dim olive bags, 4 vibrant magenta bags, 5 pale cyan bags.
wavy beige bags contain 5 dim red bags, 2 dotted crimson bags, 1 muted orange bags.
drab orange bags contain 3 dotted red bags, 1 drab yellow bags, 4 clear tan bags, 1 vibrant chartreuse bags.
mirrored turquoise bags contain 4 striped yellow bags, 1 dark yellow bags.
posh gold bags contain 2 clear maroon bags, 2 drab black bags.
posh orange bags contain 3 dark red bags, 1 dull brown bags, 1 dark green bags.
dim lavender bags contain 2 drab gray bags, 2 shiny brown bags, 2 dull tomato bags, 4 light teal bags.
muted lavender bags contain 1 striped black bags, 1 vibrant brown bags, 1 wavy yellow bags.
...
vibrant yellow bags contain 4 muted olive bags, 1 dull tomato bags, 3 bright coral bags.
muted fuchsia bags contain 3 clear maroon bags, 1 striped aqua bags, 1 pale brown bags.
dull olive bags contain 4 muted tomato bags, 1 clear silver bags.
...
striped purple bags contain 1 shiny brown bags, 1 light orange bags.
...
dim aqua bags contain 1 shiny coral bags, 2 faded teal bags, 2 plaid cyan bags, 1 plaid salmon bags.
...
faded maroon bags contain 3 mirrored turquoise bags, 1 dim black bags, 5 posh lavender bags.
...
dotted indigo bags contain 4 dim aqua bags, 4 light coral bags, 1 posh tan bags, 1 mirrored gold bags.
...
mirrored aqua bags contain 1 striped coral bags, 5 plaid violet bags, 2 bright coral bags, 5 pale orange bags.
clear lavender bags contain 2 posh chartreuse bags.
vibrant plum bags contain 5 wavy tomato bags, 3 posh tomato bags, 1 striped chartreuse bags, 1 dim cyan bags.
faded red bags contain 1 bright green bags.
...
vibrant turquoise bags contain 1 clear black bags.
dull fuchsia bags contain 1 wavy maroon bags, 1 posh black bags, 5 light magenta bags, 1 dotted tomato bags.
...
mirrored white bags contain 1 light blue bags, 2 muted gold bags.
light magenta bags contain no other bags.
dark fuchsia bags contain 2 shiny coral bags, 3 pale tomato bags.
mirrored maroon bags contain 1 dim indigo bags.
...
plaid turquoise bags contain 4 drab yellow bags, 1 vibrant lavender bags, 2 vibrant yellow bags, 5 light violet bags.
posh fuchsia bags contain 4 vibrant gold bags, 4 shiny silver bags.
clear purple bags contain 1 faded tomato bags.
mirrored coral bags contain 1 striped black bags, 3 plaid chartreuse bags.
bright beige bags contain 4 faded lavender bags, 1 faded teal bags, 3 dark red bags, 1 pale maroon bags.
...
posh green bags contain 4 bright bronze bags, 3 faded aqua bags, 1 shiny lime bags, 2 dotted magenta bags.
...
bright teal bags contain 1 mirrored gray bags, 4 faded indigo bags, 2 dim cyan bags, 1 posh plum bags.
striped orange bags contain 4 vibrant plum bags, 4 shiny cyan bags, 5 pale beige bags, 4 dim beige bags.
vibrant cyan bags contain 3 posh plum bags, 1 bright teal bags.
drab gold bags contain 1 wavy orange bags.
...
dark gold bags contain 1 clear black bags, 1 dark chartreuse bags, 1 faded lime bags, 2 bright olive bags.
striped gray bags contain 4 bright coral bags, 4 striped coral bags, 1 muted gold bags.
bright gold bags contain 2 plaid fuchsia bags, 5 striped olive bags, 2 mirrored tomato bags, 5 muted tomato bags.
wavy lavender bags contain 1 pale violet bags, 1 dotted gray bags.
...
dotted teal bags contain 1 plaid indigo bags, 4 posh salmon bags.
muted salmon bags contain 3 wavy maroon bags, 2 dotted olive bags.
dotted crimson bags contain 2 dotted bronze bags, 1 bright yellow bags, 2 dark cyan bags, 5 clear salmon bags.
striped tan bags contain 2 posh violet bags, 5 dark silver bags, 5 light teal bags.
pale maroon bags contain 1 dark cyan bags, 4 faded indigo bags.
...
bright orange bags contain 5 plaid indigo bags, 5 plaid beige bags, 1 light teal bags.
posh red bags contain 4 shiny plum bags.
light bronze bags contain 5 dark green bags, 4 shiny silver bags.
dull violet bags contain 1 mirrored gray bags, 4 shiny crimson bags.
...
vibrant green bags contain 5 dark orange bags, 1 drab yellow bags, 3 dotted plum bags.
dull lavender bags contain 2 dark tomato bags.
dim tan bags contain 1 muted teal bags, 4 dull white bags, 1 shiny gold bags.
plaid white bags contain 3 faded silver bags.
pale lime bags contain 4 plaid bronze bags, 1 posh white bags.
mirrored crimson bags contain 4 dim tan bags, 3 vibrant turquoise bags, 1 faded lime bags, 5 striped yellow bags.
...
plaid yellow bags contain 1 bright silver bags, 1 light bronze bags.
bright green bags contain 3 posh gray bags, 1 mirrored black bags.
wavy lime bags contain 1 pale white bags, 2 dim orange bags, 4 dull bronze bags.
striped turquoise bags contain 2 drab lavender bags.
dotted chartreuse bags contain 1 posh violet bags, 2 mirrored aqua bags.
faded olive bags contain 1 bright bronze bags, 3 mirrored tan bags, 3 vibrant silver bags.
dull green bags contain 4 plaid olive bags.
bright salmon bags contain 5 mirrored salmon bags, 4 muted teal bags, 1 vibrant yellow bags, 3 bright magenta bags.
...
pale yellow bags contain 1 dull crimson bags, 1 clear black bags, 5 shiny lime bags.
striped lime bags contain 1 bright aqua bags, 1 faded lime bags, 2 posh coral bags.
...
posh crimson bags contain 5 plaid bronze bags, 5 muted teal bags, 1 dark cyan bags.
muted olive bags contain 5 muted gold bags, 1 bright coral bags, 4 muted tomato bags, 2 pale maroon bags.
...
striped bronze bags contain 3 wavy tomato bags, 1 dark brown bags, 4 plaid salmon bags, 5 dark magenta bags.
dotted green bags contain 3 faded orange bags, 1 striped olive bags, 2 dark cyan bags, 2 bright coral bags.
dull lime bags contain 3 wavy black bags, 4 shiny tan bags, 2 clear crimson bags, 1 dark cyan bags.
light cyan bags contain 5 light violet bags, 5 posh black bags.
bright crimson bags contain 1 plaid tomato bags, 5 faded green bags, 2 posh chartreuse bags.
...
mirrored blue bags contain 1 wavy chartreuse bags, 1 dull plum bags, 1 plaid bronze bags.
shiny gold bags contain 1 pale maroon bags, 3 plaid blue bags, 5 dull tan bags.
clear bronze bags contain 1 pale coral bags, 1 light yellow bags.
...
light olive bags contain 5 dark white bags, 1 plaid red bags.
...
mirrored beige bags contain 1 dim plum bags.
light black bags contain 3 bright silver bags, 3 wavy chartreuse bags, 4 bright chartreuse bags.
vibrant coral bags contain 1 faded tomato bags, 3 striped coral bags.
...
dotted white bags contain 1 mirrored purple bags.
striped salmon bags contain 2 posh tomato bags, 1 muted silver bags, 3 dull violet bags, 4 mirrored plum bags.
striped red bags contain 2 posh bronze bags.
clear teal bags contain 4 vibrant aqua bags, 1 plaid lime bags, 3 bright lime bags, 1 posh beige bags.
mirrored cyan bags contain 5 light green bags.
muted teal bags contain no other bags.
drab bronze bags contain 4 dim salmon bags, 1 shiny violet bags, 1 dotted white bags, 3 wavy yellow bags.
pale fuchsia bags contain 4 plaid magenta bags.
mirrored tomato bags contain 1 shiny gray bags, 5 dull lime bags, 5 shiny turquoise bags, 1 clear crimson bags.
...
dotted salmon bags contain 5 striped bronze bags, 1 shiny bronze bags, 5 light olive bags, 2 striped magenta bags.
...
pale blue bags contain 1 mirrored lime bags.
striped lavender bags contain 1 posh white bags, 5 faded magenta bags, 5 drab crimson bags.
shiny olive bags contain 2 posh tomato bags, 1 faded indigo bags.
vibrant white bags contain 1 dark purple bags, 5 light lime bags.
light purple bags contain 4 shiny black bags.
plaid chartreuse bags contain 5 dim gray bags, 3 dull magenta bags.
faded violet bags contain 2 faded tomato bags, 1 dark aqua bags, 2 pale lavender bags.
drab maroon bags contain 1 plaid fuchsia bags.
drab turquoise bags contain 5 dull indigo bags, 1 striped tomato bags, 4 dull cyan bags, 4 vibrant plum bags.
...
pale salmon bags contain 1 wavy olive bags, 4 pale cyan bags, 2 faded tomato bags, 3 vibrant tan bags.
dull bronze bags contain 3 wavy red bags, 2 plaid red bags, 2 muted purple bags.
posh plum bags contain no other bags.
mirrored chartreuse bags contain 1 clear gray bags.
dull chartreuse bags contain 1 faded teal bags, 2 wavy orange bags, 1 bright indigo bags.
...
dull white bags contain 1 pale indigo bags, 2 bright turquoise bags.
mirrored purple bags contain 2 light bronze bags, 1 dark orange bags, 2 dark fuchsia bags, 2 striped violet bags.
...
plaid purple bags contain 3 drab yellow bags, 1 plaid green bags, 4 dim plum bags.
...
wavy white bags contain 1 pale indigo bags, 5 vibrant lavender bags, 2 dim tan bags.
posh teal bags contain 1 mirrored brown bags, 3 bright coral bags.
pale indigo bags contain 2 posh crimson bags.
muted magenta bags contain 1 muted black bags, 4 dull turquoise bags.
drab brown bags contain 5 striped gold bags.
posh beige bags contain 3 shiny gold bags, 1 shiny cyan bags, 1 posh crimson bags, 2 wavy yellow bags.
dark lavender bags contain 5 dim fuchsia bags, 5 mirrored beige bags, 1 dark indigo bags, 3 dull brown bags.
faded cyan bags contain 4 vibrant aqua bags, 2 dark magenta bags, 1 dark yellow bags, 3 wavy red bags.
bright brown bags contain 1 wavy orange bags, 3 dim plum bags.
wavy coral bags contain 4 posh yellow bags, 4 light lime bags.
bright maroon bags contain 4 clear turquoise bags, 4 posh salmon bags, 1 striped gold bags.
...
drab indigo bags contain 1 faded red bags, 5 dull maroon bags.
...
wavy fuchsia bags contain 1 light violet bags, 4 dark tomato bags, 2 bright green bags.
vibrant magenta bags contain 5 mirrored gold bags, 3 dotted red bags.
light red bags contain 2 posh crimson bags, 3 wavy orange bags, 1 wavy yellow bags.
dim crimson bags contain 3 striped tan bags, 3 pale blue bags, 2 drab yellow bags.
dark teal bags contain 1 plaid bronze bags, 1 vibrant aqua bags.
shiny magenta bags contain 3 light salmon bags, 4 dark bronze bags, 1 shiny plum bags, 4 clear blue bags.
clear lime bags contain 3 vibrant salmon bags, 5 muted magenta bags, 4 posh black bags.
dull coral bags contain 1 shiny coral bags, 2 bright black bags.
shiny black bags contain 1 dotted purple bags, 2 posh teal bags.
...
shiny brown bags contain 1 posh bronze bags.
...
striped beige bags contain 1 dim olive bags, 3 plaid chartreuse bags, 4 dark chartreuse bags.
faded indigo bags contain 5 dark cyan bags, 1 light violet bags, 2 bright coral bags.
bright aqua bags contain 1 clear salmon bags, 1 dark orange bags, 5 faded gold bags.
plaid orange bags contain 5 vibrant cyan bags, 5 plaid silver bags, 2 wavy olive bags, 2 bright olive bags.
posh bronze bags contain 1 faded indigo bags.
plaid cyan bags contain 1 muted teal bags, 5 muted olive bags, 3 dull tomato bags, 5 light magenta bags.
striped coral bags contain 2 posh black bags.
light brown bags contain 5 muted lavender bags, 2 muted coral bags, 1 vibrant tan bags, 5 drab lime bags.
shiny tomato bags contain 4 bright turquoise bags, 1 muted tomato bags, 2 clear fuchsia bags.
...
dotted purple bags contain 2 shiny brown bags, 1 bright lime bags, 4 faded lavender bags, 2 faded indigo bags.
shiny silver bags contain 1 wavy tomato bags, 1 dull gold bags, 2 striped yellow bags.
...
wavy aqua bags contain 1 vibrant turquoise bags, 5 clear gold bags, 1 muted indigo bags, 4 striped gray bags.
mirrored fuchsia bags contain 1 posh maroon bags, 2 clear salmon bags.
...
dim plum bags contain 2 pale maroon bags, 1 mirrored blue bags, 5 bright coral bags.
clear white bags contain 1 muted cyan bags, 3 mirrored gold bags.
vibrant aqua bags contain 2 dull plum bags, 4 muted tomato bags.
dark black bags contain 2 posh green bags.
muted white bags contain 2 faded green bags, 1 dull gray bags, 2 striped coral bags, 4 dim black bags.
...
drab aqua bags contain 2 posh bronze bags, 1 vibrant orange bags, 1 light magenta bags.
...
mirrored bronze bags contain 1 wavy white bags, 5 bright beige bags, 4 bright turquoise bags, 1 bright yellow bags.
dotted fuchsia bags contain 2 faded indigo bags.
pale turquoise bags contain 3 vibrant lime bags, 1 vibrant fuchsia bags, 1 dim black bags.
light lime bags contain 1 pale orange bags, 3 pale maroon bags, 4 dull maroon bags.
bright gray bags contain 5 mirrored bronze bags, 4 dotted purple bags, 5 bright beige bags, 5 posh bronze bags.
dull blue bags contain 1 dull gold bags, 3 shiny coral bags.
dark salmon bags contain 2 dark teal bags, 3 striped bronze bags, 2 pale plum bags, 5 faded teal bags.
light indigo bags contain 1 light green bags, 4 faded fuchsia bags.
light fuchsia bags contain 5 shiny black bags, 2 plaid turquoise bags.
vibrant gray bags contain 2 faded teal bags, 1 dark brown bags, 1 dark magenta bags, 3 pale white bags.
faded fuchsia bags contain 5 pale cyan bags, 2 wavy aqua bags.
wavy purple bags contain 1 posh fuchsia bags, 2 clear turquoise bags.
dark purple bags contain 5 dotted olive bags, 4 shiny tan bags, 4 clear blue bags.
vibrant chartreuse bags contain 4 clear teal bags, 1 plaid coral bags.
plaid silver bags contain 4 wavy beige bags, 5 bright aqua bags, 1 vibrant yellow bags.
dull turquoise bags contain 1 faded orange bags, 4 vibrant blue bags, 1 vibrant brown bags, 1 clear gold bags.
bright violet bags contain 4 plaid fuchsia bags, 1 clear blue bags, 4 dull purple bags, 1 dark yellow bags.
wavy turquoise bags contain 4 plaid violet bags, 4 drab gray bags.
muted tan bags contain 5 posh white bags, 3 drab salmon bags, 3 light tan bags, 1 dark cyan bags.
...
dotted cyan bags contain 2 mirrored blue bags, 5 plaid salmon bags, 1 faded orange bags, 4 dull tomato bags.
...
muted turquoise bags contain 2 light coral bags, 1 mirrored gray bags.
posh chartreuse bags contain 1 dark orange bags, 3 striped olive bags, 5 faded teal bags.
bright chartreuse bags contain 3 vibrant maroon bags.
shiny cyan bags contain 3 muted olive bags, 1 muted tomato bags.
...
clear tan bags contain 2 dim green bags, 1 mirrored gray bags, 3 dotted cyan bags.
...
vibrant bronze bags contain 5 bright olive bags, 1 dull gray bags, 3 dark purple bags.
pale green bags contain 4 muted teal bags.
clear plum bags contain 4 posh violet bags, 1 light blue bags.
...
dark crimson bags contain 4 dull tan bags, 1 shiny cyan bags, 5 vibrant indigo bags.
dim brown bags contain 3 faded silver bags, 3 dark purple bags.
dotted tan bags contain 1 dim indigo bags, 2 vibrant teal bags, 4 bright beige bags, 4 clear silver bags.
light gray bags contain 1 faded indigo bags, 1 light tan bags, 1 mirrored lime bags.
...
shiny beige bags contain 5 vibrant olive bags, 1 dull blue bags.
...
wavy teal bags contain 1 clear gray bags, 2 shiny tan bags, 4 shiny brown bags.
dull tan bags contain 1 clear silver bags.
vibrant maroon bags contain 1 faded lavender bags, 4 bright coral bags, 5 vibrant coral bags.
faded magenta bags contain 5 shiny black bags, 3 light crimson bags.
dim magenta bags contain 2 shiny tan bags.
pale coral bags contain 1 striped black bags, 2 posh violet bags.
clear salmon bags contain 5 wavy tomato bags, 4 dull gold bags, 3 dotted olive bags, 2 bright turquoise bags.
clear silver bags contain 1 bright coral bags, 3 light magenta bags, 4 muted teal bags, 4 light violet bags.
mirrored lavender bags contain 4 faded cyan bags, 4 dotted fuchsia bags, 4 mirrored salmon bags, 5 muted beige bags.
muted lime bags contain 5 vibrant olive bags, 1 light chartreuse bags, 5 faded yellow bags, 5 drab plum bags.
...
plaid olive bags contain 1 dim lime bags.
...
light tan bags contain 1 pale gold bags.
mirrored yellow bags contain 2 dim maroon bags, 1 posh violet bags, 3 drab salmon bags.
...
wavy red bags contain 1 pale maroon bags.
faded yellow bags contain 4 bright chartreuse bags, 3 striped gold bags.
faded purple bags contain 2 posh yellow bags, 2 shiny black bags, 1 dim magenta bags, 5 vibrant blue bags.
vibrant lime bags contain 5 drab tan bags, 5 pale beige bags, 1 faded turquoise bags, 4 dull gold bags.
mirrored violet bags contain 1 mirrored bronze bags.
drab crimson bags contain 2 dim indigo bags.
dim gold bags contain 5 plaid green bags.
shiny yellow bags contain 2 faded black bags, 1 posh crimson bags, 4 plaid turquoise bags, 3 pale chartreuse bags.
...
vibrant beige bags contain 1 plaid violet bags.
striped crimson bags contain 3 striped bronze bags.
light tomato bags contain 5 faded orange bags, 5 mirrored bronze bags, 1 pale orange bags.
wavy magenta bags contain 5 drab magenta bags, 2 vibrant tan bags, 2 striped indigo bags.
dotted beige bags contain 2 posh bronze bags, 1 faded silver bags.
faded gold bags contain 5 vibrant teal bags, 4 dim plum bags, 2 vibrant yellow bags.
dark blue bags contain 4 faded plum bags, 3 vibrant crimson bags, 1 vibrant maroon bags.
...
plaid green bags contain 2 dull magenta bags, 2 vibrant indigo bags, 1 dim silver bags.
...
plaid salmon bags contain 4 faded lavender bags, 1 dull olive bags, 4 posh crimson bags, 2 posh plum bags.
mirrored indigo bags contain 4 shiny orange bags, 4 dim green bags.
striped violet bags contain 1 bright teal bags, 1 bright black bags.
shiny coral bags contain 3 bright coral bags.
pale bronze bags contain 4 vibrant gray bags, 1 striped maroon bags, 4 dark magenta bags.
drab olive bags contain 4 plaid beige bags.
dull beige bags contain 4 posh orange bags.
muted yellow bags contain 2 muted teal bags, 5 bright coral bags, 4 mirrored beige bags, 1 wavy red bags.
drab tan bags contain 4 bright aqua bags, 4 dark crimson bags, 4 muted coral bags.
mirrored brown bags contain 1 muted gold bags.
striped gold bags contain 1 clear olive bags, 5 muted purple bags.
dark orange bags contain 1 mirrored aqua bags, 5 pale brown bags, 3 shiny turquoise bags, 5 dim plum bags.
dim green bags contain 1 posh crimson bags, 5 wavy yellow bags, 3 mirrored blue bags, 3 mirrored brown bags.
light green bags contain 1 dull cyan bags, 1 striped gold bags, 3 dull maroon bags.
...
dark beige bags contain 3 plaid plum bags, 4 light blue bags, 1 vibrant plum bags.
bright coral bags contain no other bags.
wavy blue bags contain 5 mirrored plum bags, 5 plaid yellow bags, 1 bright aqua bags.
shiny purple bags contain 1 wavy fuchsia bags, 4 wavy bronze bags.
...
mirrored green bags contain 4 dark cyan bags, 1 faded silver bags.
faded teal bags contain 5 clear silver bags, 3 muted olive bags, 4 light magenta bags, 3 dark cyan bags.
muted blue bags contain 2 bright teal bags, 1 vibrant tan bags.
dim blue bags contain 4 dark orange bags, 3 bright lime bags, 5 clear salmon bags, 1 striped blue bags.
plaid beige bags contain 4 posh fuchsia bags, 1 posh violet bags, 1 drab gray bags, 4 pale white bags.
wavy tomato bags contain 2 dark cyan bags, 5 clear silver bags.
plaid fuchsia bags contain 4 wavy turquoise bags, 2 clear salmon bags, 1 bright turquoise bags, 3 plaid blue bags.
bright tan bags contain 4 dotted green bags, 1 dull orange bags, 1 mirrored violet bags, 4 dim green bags.
drab white bags contain 2 dim tan bags.
light white bags contain 1 pale gold bags, 4 posh magenta bags.
clear olive bags contain 4 plaid cyan bags.
light gold bags contain 1 muted gold bags.
shiny green bags contain 4 bright maroon bags.
drab silver bags contain 5 posh gold bags, 5 drab salmon bags.
drab yellow bags contain 1 light violet bags, 2 pale maroon bags, 2 faded orange bags, 2 posh black bags.
...
pale white bags contain 5 posh plum bags, 3 pale maroon bags, 3 muted gold bags, 1 dull tan bags.
...
wavy silver bags contain 5 bright magenta bags, 5 dotted beige bags, 1 dim indigo bags.
...
dim turquoise bags contain 1 dull maroon bags, 5 light crimson bags, 4 light gold bags.
...
faded black bags contain 1 drab lavender bags, 5 posh purple bags.
posh indigo bags contain 4 faded tan bags, 1 faded teal bags, 4 pale chartreuse bags, 5 pale gray bags.
dull gray bags contain 1 light lime bags.
vibrant blue bags contain 1 dotted olive bags, 5 clear fuchsia bags.
pale brown bags contain 4 plaid salmon bags, 1 posh yellow bags, 1 faded indigo bags, 2 muted gold bags.
vibrant indigo bags contain 5 drab yellow bags, 2 dark cyan bags, 1 muted teal bags, 1 striped coral bags.
wavy chartreuse bags contain 3 muted olive bags, 2 faded teal bags.
dim chartreuse bags contain 1 wavy white bags, 5 mirrored violet bags, 4 dull fuchsia bags.
clear chartreuse bags contain 4 drab white bags, 1 muted plum bags.
drab fuchsia bags contain 4 muted teal bags, 1 shiny lime bags, 2 dotted gold bags.
...
clear fuchsia bags contain 1 posh black bags, 5 dim magenta bags.
striped teal bags contain 1 pale red bags, 2 mirrored lime bags, 1 pale blue bags.
muted maroon bags contain 1 plaid violet bags, 1 faded teal bags.
...
bright red bags contain 5 bright brown bags, 1 mirrored tan bags, 5 muted coral bags, 4 striped chartreuse bags.
shiny tan bags contain 4 posh plum bags, 1 pale maroon bags, 4 faded indigo bags, 3 posh black bags.
...
muted orange bags contain 1 dull plum bags, 1 posh red bags.
muted aqua bags contain 2 dotted olive bags, 2 dim violet bags.
dull gold bags contain 1 posh plum bags.
...
muted coral bags contain 4 striped plum bags, 1 posh green bags, 2 plaid violet bags.
drab cyan bags contain 3 wavy lime bags.
vibrant violet bags contain 2 dark orange bags, 1 drab salmon bags, 2 posh beige bags.
pale tomato bags contain 3 drab beige bags, 1 wavy coral bags.
...
plaid magenta bags contain 2 dark green bags, 1 vibrant crimson bags, 3 dotted gray bags.
faded beige bags contain 3 faded violet bags, 2 dotted green bags, 5 mirrored cyan bags.
shiny aqua bags contain 4 dotted coral bags, 3 vibrant violet bags, 3 bright maroon bags, 1 shiny cyan bags.
dim red bags contain 4 plaid blue bags, 2 plaid lime bags, 1 dark red bags.
pale violet bags contain 3 mirrored white bags, 2 posh white bags.
faded aqua bags contain 1 faded silver bags, 5 clear fuchsia bags.
dim silver bags contain 1 muted gold bags, 1 dim tan bags, 3 striped yellow bags, 5 faded indigo bags.
dotted maroon bags contain 3 bright teal bags, 1 clear white bags.
...
clear yellow bags contain 1 shiny green bags.
bright turquoise bags contain 3 wavy chartreuse bags.
muted black bags contain 1 muted gold bags.
faded coral bags contain 1 posh plum bags.
striped white bags contain 3 clear coral bags, 2 plaid blue bags, 4 plaid aqua bags, 5 drab brown bags.
bright cyan bags contain 1 faded teal bags, 4 dim coral bags, 5 shiny red bags.
...
posh magenta bags contain 5 pale red bags, 1 drab white bags, 5 pale white bags, 5 dotted plum bags.
clear coral bags contain 3 dark chartreuse bags.
dull aqua bags contain 4 clear blue bags, 1 dotted green bags.
muted brown bags contain 2 shiny brown bags, 2 clear fuchsia bags, 5 pale yellow bags, 1 dotted tan bags.
vibrant lavender bags contain 1 posh crimson bags.
...
dark tan bags contain 1 dull plum bags, 2 muted teal bags, 3 mirrored brown bags, 3 faded teal bags.
muted tomato bags contain no other bags.
muted violet bags contain 1 drab green bags, 5 wavy green bags.
dotted bronze bags contain 5 dim tan bags.
shiny violet bags contain 4 posh beige bags, 4 pale lime bags, 1 dim aqua bags.
clear indigo bags contain 1 wavy olive bags, 5 dim purple bags, 5 striped blue bags.
...
wavy black bags contain 3 clear salmon bags, 4 light teal bags, 1 clear fuchsia bags, 5 dull tan bags.
...
dim black bags contain 3 faded blue bags, 1 dark white bags.
mirrored olive bags contain 3 mirrored beige bags, 1 striped tomato bags, 3 wavy olive bags.
bright white bags contain 5 posh teal bags, 2 dark purple bags, 2 bright tan bags.
mirrored lime bags contain 1 muted tomato bags, 2 dark red bags, 5 plaid bronze bags.
dark coral bags contain 1 striped chartreuse bags, 5 bright gray bags.
dotted coral bags contain 3 posh crimson bags, 5 posh fuchsia bags.
dim orange bags contain 1 dim magenta bags, 3 clear turquoise bags, 4 pale lime bags, 3 faded teal bags.
...
posh white bags contain 1 vibrant aqua bags.
drab black bags contain 3 vibrant yellow bags, 2 vibrant teal bags, 5 dark teal bags.
shiny red bags contain 4 dotted tan bags, 1 faded plum bags, 4 drab magenta bags.
pale gold bags contain 3 dull magenta bags.
faded turquoise bags contain 1 mirrored maroon bags, 3 vibrant purple bags.
...
dark olive bags contain 4 vibrant chartreuse bags, 4 light coral bags, 1 faded purple bags.
...
striped indigo bags contain 3 wavy red bags, 5 posh white bags, 5 light tan bags, 1 plaid bronze bags.
wavy crimson bags contain 2 dull fuchsia bags, 5 striped tomato bags.`

// input find & replace, bag => bags & then bagss => bags
...
const partOne = () => {
  ...
  console.log('part one', outerBags.size);
}
